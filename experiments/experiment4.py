...
if __name__ == "__main__":
    ...
    result = []
    param_grid = np.array(np.meshgrid(n_list, glm_list)).T.reshape(-1, 2)
    burnin = 2500
    particle_number = 1000

    for n, glm in param_grid:
    ...
    with open(f'results/experiment4.json', 'w') as file:
        json.dump(result, file)
    print(f"The Experiment 4 is finished.")
